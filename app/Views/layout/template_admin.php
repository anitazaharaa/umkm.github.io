  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link <?= ($navtitle == 'Laporan UMKM') ? 'active' : '' ?>" href="../pages/rtl.html">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link <?= ($navtitle == 'User Management') ? 'active' : '' ?>" href="../pages/rtl.html">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3 ">
        <div class="float-start">
          <h5 class="mt-3 mb-0">SiUMKM Configurator</h5>
    ...
    new Chart(ctx1, {
      ...
      data: {
        ...
        datasets: [{
          ...
          borderWidth: 3,
          fill: true,
          data: [50, 40, 300, 220, 500, 250, 400, 230, 500, 220, 500, 250, 400, 230, 500, 220, 500, 250, 400, 230, 500, 220, 500, 250, 400, 230, 500, 40, 300, 220, 500, 250, 400, 230, 500, 220, 500, 250, 400],
          maxBarThickness: 6
